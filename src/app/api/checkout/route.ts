...
export async function POST(request: Request) {
  ...
  // Tips open after admin login issuance (status active). Subscription/trial is
  // billing only — suspended / pending / deleted stores stay closed.
  if (!isStoreAcceptingTips(store.status)) {
